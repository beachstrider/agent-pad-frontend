          ...
          {messages.map((message) => {
            ...
            return (
              <motion.div
                ...
                exit={{ opacity: 0, y: -20 }}
                className={`bg-[var(--card2)] rounded-lg p-2 sm:p-3 ${message.reply_to ? 'ml-2 sm:ml-4 border-l-2 border-[var(--card)]' : ''}`}
              >
                {parentMessage && (
                  <div className="mb-1 sm:mb-2 text-[10px] sm:text-xs text-subtext bg-[var(--card)] p-1.5 sm:p-2 rounded">
                ...
                <div className="flex items-start gap-1.5 sm:gap-2">
                  ...
                  <div className="flex-grow min-w-0">
                    ...
                    <button
                      ...
                      className="mt-1 sm:mt-2 text-[10px] sm:text-xs text-subtext hover:text-[var(--primary)] flex items-center gap-0.5 sm:gap-1"
                    >
      ...
      <form onSubmit={handleSendMessage} className="mt-2 sm:mt-4 space-y-1 sm:space-y-2 p-2">
        ...
        <div className="flex gap-1.5 sm:gap-2">
          ...
          <button
            ...
            className="bg-[var(--primary)] text-black px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg text-xs sm:text-sm font-medium hover:bg-[var(--primary)] transition-colors disabled:opacity-50"
          >
            Send
          </button>
        </div>
