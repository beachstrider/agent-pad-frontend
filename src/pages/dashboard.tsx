  ...
  return (
    <div className="flex items-center justify-center mt-6 space-x-2">
      <button
        ...
        className="p-1 rounded-md bg-gray-800 text-subtext hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200"
      >
              ...
              <button
                ...
                className={`px-2 py-1 text-xs sm:text-sm rounded-md transition-colors duration-200 ${
                  currentPage === page
                    ...
                    : 'bg-gray-800 text-subtext hover:bg-gray-700'
                }`}
              >
                {page}
              </button>
...
const UserDashboard: React.FC = () => {
  ...
  return (
    <Layout>
      <SEO 
        title="Agent Pad Token Control Center"
        description="MAccess all your tokens and transaction history in one streamlined dashboard, tailored for a seamless Agent Pad experience.."
        image="seo/dash.jpg"
      />
              ...
              <table className="min-w-full divide-y divide-gray-700">
                <thead className="bg-gray-900">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-[10px] sm:text-xs font-medium text-gray-300 uppercase tracking-wider">$AIMG</th>
